...
<head>
    ...
    <link rel="stylesheet" href="http://electronico.pjedomex.gob.mx/electronico/vistas/css/font-awesome/css/font-awesome.min.css">
</head>

<body>
    <!--Aquí va el menu-->
    <div id="header">
        <nav class="navbar navbar-expand-lg  navbar-dark sticky-top  bg-red-pj">
